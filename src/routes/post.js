...
const {createPost,getAllPost,getPost,updatePost,deletePost,Likes,unLikes}=require('../controllers/post')
...
router.route('/likes/:id').post(Likes);
router.route('/unlikes/:id').post(unLikes);
